...
namespace STATE_ESTIMATOR {
    ...
    void StateEstimator::getPositionDelta(Encoder::Capture encoderCaptures[4], float& distance_travelled) const {
        ...
        float left_travel = encoderCaptures[MOTOR_POSITION::REAR_LEFT].radians_delta() / 2;
        float right_travel = encoderCaptures[MOTOR_POSITION::REAR_RIGHT].radians_delta() / 2;
