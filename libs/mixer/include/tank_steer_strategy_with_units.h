...
#ifndef OSOD_MOTOR_2040_TANK_STEER_STRATEGY_WITH_UNITS_H
#define OSOD_MOTOR_2040_TANK_STEER_STRATEGY_WITH_UNITS_H
#include "mixer_strategy.h"


namespace MIXER {

    class TankSteerWithUnitsStrategy : public MixerStrategy {
    ...
    public:
        ...
        TankSteerWithUnitsStrategy(float trackWidth, float wheelBase)
...
#endif //OSOD_MOTOR_2040_TANK_STEER_STRATEGY_WITH_UNITS_H
